...
<html>
	...
	<div id="header">
			...
			<tr><td><div><marquee direction="up" width="300px" truespeed="truespeed" onmouseover="stop()" onmouseout="start()" style="color: red;">Last Date of fee Submission is December/10/16
															     After that You'll have to pay 50 dollars 
															     per day as a fine and your tution fee
	...
	<div id="sidebar">
			...
			<div id="header">
					<h4>
						Copyright 2016 All rights reserved.fore more information please visit: <a href="https://github.com/praveenksuja/Payment-Billing-System"><font style="color: yellow;">Praveen_GitHub</font></a>
					</h4>
			</div>
